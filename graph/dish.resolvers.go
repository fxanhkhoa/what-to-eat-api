...
func (r *queryResolver) Dishes(ctx context.Context, keyword *string, page *int, limit *int, tags *string, preparationTimeFrom *int, preparationTimeTo *int, cookingTimeFrom *int, cookingTimeTo *int, difficultLevels *string, mealCategories *string, ingredientCategories *string, ingredients *string) ([]*model.Dish, error) {
	inputTags := []string{}
	if tags != nil {
